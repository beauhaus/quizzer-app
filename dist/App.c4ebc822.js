...
},{"./cjs/react.development.js":"../node_modules/react/cjs/react.development.js"}],"../node_modules/warning/browser.js":[function(require,module,exports) {
/**
...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/@reach/router/es/lib/utils.js":[function(require,module,exports) {
"use strict";
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "pre",
            null,
            JSON.stringify(this.props.media, null, 2)
          )
        ),
        _react2.default.createElement(
          "div",
...
var petfinder = (0, _petfinderClient2.default)({
  key: "3cb89639c8bafd4e0eb569af5896c230",
  secret: "f160a9c4f6ede1b665d2581b470c379c"
});
...
var Results = function (_React$Component) {
  ...
  _createClass(Results, [{
    ...
    value: function componentDidMount() {
      ...
      petfinder.pet.find({ find: "full", location: "Seattle, WA" }).then(function (data) {
        var pets = void 0;
        if (data.petfinder.pets && data.petfinder.pets.pet) {
          ...
          if (Array.isArray(data.petfinder.pets.pet)) {
            ...
            //if just one, wrap it in an array
            pets = [data.petfinder.pets.pet];
          }
        } else {
          pets = [];
        ...
        _this2.setState({ pets: pets }); //es6 terseness
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "search" },
        this.state.pets.map(function (pet, idx) {
          var breed = void 0;
...
var Details = function (_React$Component) {
  ...
  // first load it wont have data from API
...
},{"react":"../node_modules/react/index.js","@reach/router":"../node_modules/@reach/router/es/index.js","petfinder-client":"../node_modules/petfinder-client/index.js"}],"../node_modules/idb-keyval/dist/idb-keyval.mjs":[function(require,module,exports) {
'use strict';
...
exports.clear = clear;
exports.keys = keys;
},{}],"IndexDB.js":[function(require,module,exports) {
"use strict";
...
var IndexDB = function (_React$Component) {
  _inherits(IndexDB, _React$Component);
  ...
  function IndexDB() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndexDB.__proto__ || Object.getPrototypeOf(IndexDB)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      DBloading: true
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  // first load it wont have data from API
  ...
  _createClass(IndexDB, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _idbKeyval.set)("foo", "bar");
      (0, _idbKeyval.get)("foo").then(function (data) {
...
},{"react":"../node_modules/react/index.js","idb-keyval":"../node_modules/idb-keyval/dist/idb-keyval.mjs"}],"LocalDB.js":[function(require,module,exports) {
"use strict";
...
var LocalDB = function (_React$Component) {
  _inherits(LocalDB, _React$Component);
  ...
  function LocalDB() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LocalDB.__proto__ || Object.getPrototypeOf(LocalDB)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      DBloading: true
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  // first load it wont have data from API
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_IndexDB2.default, null),
        _react2.default.createElement(_LocalDB2.default, null),
...
},{"react":"../node_modules/react/index.js","@reach/router":"../node_modules/@reach/router/es/index.js","react-dom":"../node_modules/react-dom/index.js","./Results":"Results.js","./Details":"Details.js","./IndexDB":"IndexDB.js","./LocalDB":"LocalDB.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/App.c4ebc822.map